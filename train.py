...
class Train:
    ...
    def deploy_model(self):
        ...
        self.model.save_weights(os.path.join(self.model_path, r'C:\Users\alika\Desktop\pneumoniadetection\classifier\models\weights.h5'))
        self.model.save(os.path.join(self.model_path, r'C:\Users\alika\Desktop\pneumoniadetection\classifier\models\model.h5'))
